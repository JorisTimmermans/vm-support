...
_FOLDER = base_path + 'out'


def test_create_sym_link_single_file():
    file_ref = FileRef(base_path + '/ASTGTM2_N36W006_dem.tif', None, None, 'image/tiff')
    ...
    try:
        ...
        if os.path.islink(base_path + '/out/ASTGTM2_N36W006_dem.tif'):
            os.unlink(base_path + '/out/ASTGTM2_N36W006_dem.tif')
        if os.path.exists(_FOLDER):
            shutil.rmtree(_FOLDER)


def test_create_sym_link_s2_aws_data():
    file_ref = FileRef(base_path + '/29/S/QB/2017/9/4/0', None, None, 'application/x-directory')
    ...
    try:
        ...
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/B01.jp2')
        # assert 'B02.jp2' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/B02.jp2')
        # assert 'B03.jp2' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/B03.jp2')
        # assert 'B04.jp2' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/B04.jp2')
        # assert 'B05.jp2' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/B05.jp2')
        # assert 'B06.jp2' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/B06.jp2')
        # assert 'B07.jp2' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/B07.jp2')
        # assert 'B08.jp2' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/B08.jp2')
        # assert 'B09.jp2' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/B09.jp2')
        # assert 'B8A.jp2' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/B8A.jp2')
        # assert 'B10.jp2' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/B10.jp2')
        # assert 'B11.jp2' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/B11.jp2')
        # assert 'B12.jp2' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/B12.jp2')
        # assert 'metadata.xml' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/metadata.xml')
        # assert 'qi' in new_list
        # assert os.path.islink(base_path + '/out/29/S/QB/2017/9/4/0/qi/some_file')
    finally:
        if os.path.exists(base_path + '/out/29/S/QB/2017/9/4/0/'):
            shutil.rmtree(base_path + '/out/')


def test_create_symlinks_ASTER():
    file_refs = [FileRef(base_path + '/ASTGTM2_N36W006_dem.tif', None, None, 'image/tiff'),
                 FileRef(base_path + '/ASTGTM2_N36W007_dem.tif', None, None, 'image/tiff')]
    ...
    try:
        ...
        if os.path.islink(base_path + '/out/ASTGTM2_N36W006_dem.tif'):
            os.unlink(base_path + '/out/ASTGTM2_N36W006_dem.tif')
        if os.path.islink(base_path + '/out/ASTGTM2_N36W007_dem.tif'):
            os.unlink(base_path + '/out/ASTGTM2_N36W007_dem.tif')
        if os.path.exists(_FOLDER):
            shutil.rmtree(_FOLDER)
...
def test_create_symlinks_s2_aws_data_type_given():
    file_refs = [FileRef(base_path + '/29/S/QB/2017/9/4/0', None, None, 'application/x-directory'),
                 FileRef(base_path + '/30/T/XZ/2016/2/2/1/', None, None, 'application/x-directory')]
